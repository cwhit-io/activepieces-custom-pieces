...
export const listHouseholdsAction = createAction({
	auth: planningCenterAuth,
	name: 'list_households',
	displayName: 'List Households',
	description: 'Lists household (family) records.',
	audience: 'both',
	aiMetadata: {
		description:
			'List households. Use for family-based automations and household membership workflows. Read-only and safe to retry.',
		idempotent: true,
	},
	props: {
