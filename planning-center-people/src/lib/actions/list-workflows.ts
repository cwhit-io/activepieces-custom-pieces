...
export const listWorkflowsAction = createAction({
	...
	description: 'Lists People workflows (pathways/status automations).',
	audience: 'both',
	aiMetadata: {
		description:
			'List People workflows. Use for pathway and status automations. Read-only and safe to retry.',
		idempotent: true,
	},
	props: {
